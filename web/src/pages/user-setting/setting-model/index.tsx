...
const ModelProviders = () => {
  ...
  return (
    <div className="flex w-full border-[0.5px] border-white/10 rounded-lg relative ">
      <Spotlight />
      <section className="flex flex-col gap-4 w-3/5 px-5 border-r-[0.5px] border-white/10 overflow-auto scrollbar-auto">
        <SystemSetting
