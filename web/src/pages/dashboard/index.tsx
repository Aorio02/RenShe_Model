    ...
    <div className="min-h-screen w-full relative overflow-hidden bg-gradient-to-br from-[#0c5baf] via-[#09478f] to-[#06336a] text-white font-sans">
      ...
      <div className="relative z-10 w-full h-[calc(100vh-6rem)] flex flex-col justify-center px-16 lg:px-24">
        ...
        <div className="absolute top-0 xl:top-4 left-16 lg:left-24 max-w-xl pr-4">
          ...
          <ul className="space-y-4 text-xl tracking-wider text-white">
            <li>
              <Link
                to="/social-security"
                className="flex items-center gap-3 hover:text-blue-300 transition-colors cursor-pointer w-fit"
              >
        ...
        <div className="absolute bottom-32 left-0 w-full flex gap-8 lg:gap-12 justify-center px-10">
          ...
          <Link
            to="/datasets"
            className="w-[380px] h-[180px] group bg-white/20 backdrop-blur-xl border border-white/30 rounded-2xl shadow-xl flex items-center justify-center px-8 gap-6 hover:bg-white/30 hover:scale-105 transition-all duration-300 cursor-pointer overflow-hidden relative"
          >
            ...
            <div className="w-16 h-16 bg-gradient-to-b from-yellow-300 to-amber-500 rounded-xl flex items-center justify-center shadow-lg shrink-0">
              <Book size={32} className="text-white" />
            </div>
            <span className="text-[24px] font-medium tracking-wide">
              人社知识库管理
            </span>
          </Link>
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent -translate-x-[150%] group-hover:translate-x-[150%] transition-transform duration-700"></div>
            <div className="w-16 h-16 bg-gradient-to-b from-blue-300 to-blue-500 rounded-xl flex items-center justify-center shadow-lg shrink-0">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent -translate-x-[150%] group-hover:translate-x-[150%] transition-transform duration-700"></div>
            <div className="w-16 h-16 bg-gradient-to-b from-green-400 to-green-600 rounded-xl flex items-center justify-center shadow-lg shrink-0">
      ...
      {/* Bottom decoration lines (simulating the stage/circular tech lines) */}
