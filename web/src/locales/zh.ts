export default {
  translation: {
    common: {
      ...
      socialSecurityNumberPlaceholder: "请输入10-18位社保卡号",
      socialSecurityNumberError: "请输入有效的10-18位社保卡号",
      date: "年月日",
      datePlaceholder: "请输入年月日（格式：YYYY-MM-DD）",
      dateFormatError: "日期格式错误，请使用YYYY-MM-DD格式",
      exporting: "导出中..."
    },
    login: {
      loginTitle: '登录账户',
...
General：实体和关系提取提示来自 GitHub - microsoft/graphrag：基于图的模块化检索增强生成 (RAG) 系统`,
    ...
    chat: {
      ...
      enterSocialSecurityToExport: '请输入您的社保卡号以验证身份并导出聊天记录。',
      socialSecurityNumber: '社保卡号',
      pleaseEnterSocialSecurity: '请输入10-18位社保卡号',
      exporting: '正在校验并导出...',
      pleaseWait: '请稍候',
      exportFailed: '导出失败',
      checkSocialSecurity: '请检查社保卡号是否正确',
      exportSuccess: '导出成功',
